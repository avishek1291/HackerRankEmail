...
export class MailList extends React.Component {
  ...
  paginate(mails) {
    ...
    console.log('state.startmail',this.state.startmail)
  ...
  render() {
    ...
    if (this.props.display == "inbox") {
      ...
      console.log('inside if ocl',results);
    ...
    if (results && results.length > 0) {
      ...
      console.log('this is search text',this.state.searchText)
      ...
      console.log('mail_list_per_page',mail_list_per_page)
    ...
    if (!mail_list) {
      console.log('inside not maillist')
      is_last = true;
    }
